...
tipo_t create_var_s(){
    ...
    strcpy(s.atributos.var_s.tipo,"integer");
...
tipo_t create_var_f(){
    ...
    strcpy(s.atributos.var_f.tipo,"integer");
...
tipo_t create_var_r(){
    ...
    strcpy(s.atributos.var_r.tipo,"integer");
...
tipo_t create_func(){
    ...
    strcpy(s.atributos.func.tipo,"integer");
...
void altera_tipo(char* tipo, fila_tipos* f, int t){
    tipo_t s;
    ...
    for (int i = 0; i < t; i++){
        ...
        switch (s.tipo){
        case VARIAVEL_SIMPLES: {strcpy(s.atributos.var_s.tipo, tipo); break;}
        case PARAMETRO_FORMAL: {strcpy(s.atributos.var_f.tipo, tipo); break;}
        case PARAMETRO_REAL: {strcpy(s.atributos.var_r.tipo, tipo); break;}
        case FUNCAO: {strcpy(s.atributos.func.tipo, tipo); break;}
        }
...
void get_tipo(tipo_t s, char* temp){
    switch (s.tipo){
        case VARIAVEL_SIMPLES: {strcpy(temp,s.atributos.var_s.tipo); break;}
        case PARAMETRO_FORMAL: {strcpy(temp,s.atributos.var_f.tipo); break;}
        case PARAMETRO_REAL: {strcpy(temp,s.atributos.var_r.tipo); break;}
        case FUNCAO: {strcpy(temp,s.atributos.func.tipo); break;}
    }
